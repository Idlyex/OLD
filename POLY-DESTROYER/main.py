...
def parse_args():
    ...
    parser.add_argument("--record-prices", action="store_true", dest="record_prices",
                        help="Enable HF Pyth vs Binance price comparison recording (0.3s)")
...
def run_live(args):
    ...
    if getattr(args, 'record_prices', False):
        trader._record_prices = True
        log.info("📊 Price comparison recording enabled")
